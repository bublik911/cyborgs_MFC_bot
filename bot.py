...
from handlers import start, create_event, marking, create_player, menu
...
async def main():
    ...
    dp.include_routers(start.router, menu.router, create_event.router, marking.router, create_player.router)
